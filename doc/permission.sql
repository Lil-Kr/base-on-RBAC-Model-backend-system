...
CREATE TABLE `sys_dept`  (
  ...
  `number` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '组织编号',
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '组织名称',
  `parent_id` bigint(22) NOT NULL COMMENT '父id',
  `level` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '组织层级, 0. / 0.1, 0.2',
  `seq` int(2) DEFAULT NULL COMMENT '排序, 组织咋当前层级目录下的顺序',
...
CREATE TABLE `sys_log`  (
  ...
  `type` int(2) NOT NULL COMMENT '1组织，2用户，3权限模块, 4权限， 5角色, 6角色用户关系, 7角色权限关系',
...
CREATE TABLE `sys_user`  (
  ...
  `dept_id` bigint(22) DEFAULT NULL COMMENT '用户所在组织id',
